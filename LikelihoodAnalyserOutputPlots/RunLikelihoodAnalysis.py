...
if __name__ == '__main__':
	...
	NeutrinoChiSqLeptonicBHist = TH1F("NeutrinoChiSqLeptonicB","NeutrinoChiSqLeptonicB", 300, 0, 10)
	NeutrinoChiSqWHist = TH1F("NeutrinoChiSqW","NeutrinoChiSqW", 300, 0, 10)
	NeutrinoChiSqFalseBHist = TH1F("NeutrinoChiSqFalseB","NeutrinoChiSqFalseB", 300, 0, 10)
	...
	integral = NeutrinoChiSqLeptonicBHist.Integral()
	NeutrinoChiSqLeptonicBHist.Scale(1/integral)
	integral = NeutrinoChiSqWHist.Integral()
	NeutrinoChiSqWHist.Scale(1/integral)
	integral = NeutrinoChiSqFalseBHist.Integral()
	...
	TrueHadronicMTvsMWHist.Draw("surf2")
	...
	NeutrinoChiSqLeptonicBHist.SetTitle("NeutrinoChi2; Chi2; Normalised Number of Events")
