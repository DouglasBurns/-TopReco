...
if __name__ == '__main__':
	...
	inputTree = "TTbar_plus_X_analysis/MuPlusJets/Ref selection/LikelihoodReco/Discriminator"
	inputTreeSolution = "TTbar_plus_X_analysis/MuPlusJets/Ref selection/LikelihoodReco/TopReco"
	...
	file = TFile("Mu_Likelihood.root", "RECREATE")
	...
	Massleg.Draw()
	MassCanvas.Update()
	MassCanvas.SaveAs("plots/Total_Mu_MassDiscrimBest.png")
	MassCanvas.Write()
	...
	CSVleg.Draw()
	CSVCanvas.Update()
	CSVCanvas.SaveAs("plots/Total_Mu_CSVDiscrimBest.png")
	CSVCanvas.Write()
	...
	NuChi2leg.Draw()
	NuChi2Canvas.Update()
	NuChi2Canvas.SaveAs("plots/Total_Mu_NuChi2DiscrimBest.png")
	NuChi2Canvas.Write()
	...
	Allleg.Draw()
	AllCanvas.Update()
	AllCanvas.SaveAs("plots/TotalAll_Mu_DiscrimBest.png")
	AllCanvas.Write()
