...
if __name__ == '__main__':
	...
	Diff_TopPt_Hist_Correct = TH1D("Diff_TopPt_Correct","Diff_TopPt_Correct", 200, 0, 400)
	Diff_TopPt_Hist_Incorrect = TH1D("Diff_TopPt_Incorrect","Diff_TopPt_Incorrect", 200, 0, 400)
	...
	Diff_TopEta_Hist_Correct = TH1D("Diff_TopEta_Correct","Diff_TopEta_Correct", 200, -5, 5)
	Diff_TopEta_Hist_Incorrect = TH1D("Diff_TopEta_Incorrect","Diff_TopEta_Incorrect", 200, -5, 5)
	...
	Diff_TopEnergy_Hist_Correct = TH1D("Diff_TopEnergy_Correct","Diff_TopEnergy_Correct", 200, 0, 400)
	Diff_TopEnergy_Hist_Incorrect = TH1D("Diff_TopEnergy_Incorrect","Diff_TopEnergy_Incorrect", 200, 0, 400)
	...
	Diff_TopMass_Hist_Correct = TH1D("Diff_TopMass_Correct","Diff_TopMass_Correct", 200, 0, 400)
	Diff_TopMass_Hist_Incorrect = TH1D("Diff_TopMass_Incorrect","Diff_TopMass_Incorrect", 200, 0, 400)
	...
	Diff_WPt_Hist_Correct = TH1D("Diff_WPt_Correct","Diff_WPt_Correct", 200, 0, 400)
	Diff_WPt_Hist_Incorrect = TH1D("Diff_WPt_Incorrect","Diff_WPt_Incorrect", 200, 0, 400)
	...
	Diff_WEta_Hist_Correct = TH1D("Diff_WEta_Correct","Diff_WEta_Correct", 200, -5, 5)
	Diff_WEta_Hist_Incorrect = TH1D("Diff_WEta_Incorrect","Diff_WEta_Incorrect", 200, -5, 5)
	...
	Diff_WEnergy_Hist_Correct = TH1F("Diff_WEnergy_Correct","Diff_WEnergy_Correct", 200, 0, 400)
	Diff_WEnergy_Hist_Incorrect = TH1F("Diff_WEnergy_Incorrect","Diff_WEnergy_Incorrect", 200, 0, 400)
	Diff_WEnergy_Hist_NotSemiLeptonic = TH1F("Diff_WEnergy_NotSemiLeptonic","Diff_WEnergy_NotSemiLeptonic", 200, 0, 400)
	Diff_WEnergy_Hist_NotReconstructible = TH1F("Diff_WEnergy_NotReconstructible","Diff_WEnergy_NotReconstructible", 200, 0, 400)

	Diff_WMass_Hist_Correct = TH1F("Diff_WMass_Correct","Diff_WMass_Correct", 200, 0, 400)
	Diff_WMass_Hist_Incorrect = TH1F("Diff_WMass_Incorrect","Diff_WMass_Incorrect", 200, 0, 400)
	Diff_WMass_Hist_NotSemiLeptonic = TH1F("Diff_WMass_NotSemiLeptonic","Diff_WMass_NotSemiLeptonic", 200, 0, 400)
	Diff_WMass_Hist_NotReconstructible = TH1F("Diff_WMass_NotReconstructible","Diff_WMass_NotReconstructible", 200, 0, 400)
	
	Tree = "likelihood/Diagnostic"
	Tree_Solution = "TTbar_plus_X_analysis/MuPlusJets/Ref selection/LikelihoodReco/TopReco"
	...
	for event in Chain:
		...
		if (TypeofSolution == 1):#Correct = 1
			Diff_TopPt_Hist_Correct.Fill(Diff_TopPt)
			Diff_TopEta_Hist_Correct.Fill(Diff_TopEta)
			Diff_TopEnergy_Hist_Correct.Fill(Diff_TopEnergy)
			Diff_WPt_Hist_Correct.Fill(Diff_WPt)
			Diff_WEta_Hist_Correct.Fill(Diff_WEta)
			Diff_WEnergy_Hist_Correct.Fill(Diff_WEnergy)

		if (TypeofSolution == 2):#Reconstruction Chose Wrong Combination = 2
			Diff_TopPt_Hist_Incorrect.Fill(Diff_TopPt)
			Diff_TopEta_Hist_Incorrect.Fill(Diff_TopEta)
			Diff_TopEnergy_Hist_Incorrect.Fill(Diff_TopEnergy)
			Diff_WPt_Hist_Incorrect.Fill(Diff_WPt)
			Diff_WEta_Hist_Incorrect.Fill(Diff_WEta)
			Diff_WEnergy_Hist_Incorrect.Fill(Diff_WEnergy)
	...
	file = TFile("Mu_TopDiagnostics.root", "RECREATE")
	...
	Diff_TopPtCanvas.SaveAs("plots/Mu_Diff_TopPt.png")
	...
	Diff_TopEtaCanvas.SaveAs("plots/Mu_Diff_TopEta.png")
	...
	Diff_TopEnergyCanvas.SaveAs("plots/Mu_Diff_TopEnergy.png")
	...
	Diff_TopMassCanvas.SaveAs("plots/Mu_Diff_TopMass.png")
	...
	Diff_WPtCanvas.SaveAs("plots/Mu_Diff_WPt.png")
	...
	Diff_WEtaCanvas.SaveAs("plots/Mu_Diff_WEta.png")
	...
	Diff_WEnergyCanvas.SaveAs("plots/Mu_Diff_WEnergy.png")
	...
	Diff_WMassCanvas.SaveAs("plots/Mu_Diff_WMass.png")
	...
	NormalisedDiff_TopPtCanvas.SaveAs("plots/Mu_NormalisedDiff_TopPt.png")
	...
	NormalisedDiff_TopEtaCanvas.SaveAs("plots/Mu_NormalisedDiff_TopEta.png")
	...
	NormalisedDiff_TopEnergyCanvas.SaveAs("plots/Mu_NormalisedDiff_TopEnergy.png")
	...
	NormalisedDiff_TopMassCanvas.SaveAs("plots/Mu_NormalisedDiff_TopMass.png")
	...
	NormalisedDiff_WPtCanvas.SaveAs("plots/Mu_NormalisedDiff_WPt.png")
	...
	NormalisedDiff_WEtaCanvas.SaveAs("plots/Mu_NormalisedDiff_WEta.png")
	...
	NormalisedDiff_WEnergyCanvas.SaveAs("plots/Mu_NormalisedDiff_WEnergy.png")
	...
	NormalisedDiff_WMassCanvas.SaveAs("plots/Mu_NormalisedDiff_WMass.png")
